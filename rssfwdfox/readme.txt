...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\rssfwdfox on
     Windows, /home/user/dev/rssfwdfox on Linux) in a file named
     rssfwdfox@mweiguo and copy that file to
